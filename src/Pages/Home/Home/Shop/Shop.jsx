    ...
    return (
        <div className="bg-[#F8F8F8]">
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-4 xl:py-28 lg:py-28 md:py-28 pt-28">
                ...
                <a href="#" className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 cursor-pointer">
                    {sliceProduct.map((product, index) => (   
                            <div className="flex mt-8" key={index}>
                                <div>
                                    ...
                                    src={product.image}
                                    className="aspect-square h-24 w-20 object-cover"
                                    />
                                </div>
                                ...
                                <div className="flex flex-1 flex-col justify-between">
                                    ...
                                    <div>
                                        <h3 className="font-bold uppercase text-black text-xl">
                                        {product.blogName}
                                        </h3>
                                    </div>
